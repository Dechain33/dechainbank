  ...
  return (
    ...
    >
      <div className="px-2 md:px-0 py-10 mx-auto max-w-2xl lg:max-w-4xl">
        <div className="shadow-xl shadow-gray-600 flex flex-col items-center bg-white max-w-2xl lg:max-w-4xl border-[#00A2FF] border-2 rounded-3xl py-10 px-4">
        ...
        <div className="w-full flex justify-center items-center flex-wrap gap-2 sm:gap-4 my-8 sm:my-20">
          <section className="flex items-center justify-center flex-col gap-2">
            <div className="font-semibold text-xl text-center">{textThree}</div>
            <div className="relative">
              <div
                className="shadow-2xl shadow-gray-600 w-32 h-20 sm:w-36 sm:h-24 text-[#00A2FF] lg:w-48 lg:h-32 rounded-lg flex items-center justify-center text-2xl md:text-3xl lg:text-4xl border-[#00A2FF] border-2"
                style={{
                  backgroundImage:
                    "linear-gradient(to bottom, rgba(213, 227, 255, 1), rgba(213, 227, 255, 0.1))",
                }}
