  ...
  return (
    ...
    >
      <div className="px-2 md:px-0 py-6 mx-auto max-w-2xl lg:max-w-4xl">
        ...
        {registrationStatus ? (
          <div className="mb-10 flex flex-col items-center shadow-xl shadow-gray-600 bg-white max-w-2xl lg:max-w-4xl border-[#00A2FF] border-2 rounded-3xl py-10 px-4">
